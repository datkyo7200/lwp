	...
	'size' => array(
		...
		'options' => array(
			...
			'full_height_offset' => array(
				'type' => 'number',
				'label' => __('Full height decrement:', 'motopress-slider-lite'),
				'description' => __('Positive value will decrease and negative value will increase slider height', 'motopress-slider-lite'),
				'default' => '',
				'dependency' => array(
